		...
		<section className='w-full bg-gray-100 min-h-screen flex justify-center items-center'>
			<div className='w-full max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg'>
				...
				<div className='flex flex-col items-center '>
					<button
						className='mt-8 w-2/4 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-300'
					...
					<button
						onClick={() => navigate('/')}
						className='flex items-center justify-center gap-1 w-1/2 my-3 bg-slate-300 py-2 px-4'
					>
						<FaArrowLeft />
						Voltar
					</button>
